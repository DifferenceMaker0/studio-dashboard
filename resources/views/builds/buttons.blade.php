...
<div>   
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              ...
              <div style="display:inline-block;position:relative;width:178px;height:50px;z-index:100;">
                <i style="margin-left:40px;"></i><button class="button-71" role="button"> Button 71</button>
              </div>

              </div>
              <div class="card-body pad table-responsive bg-aluminum">
  ...
  <a id="back-to-top" href="#top" class="btn btn-primary back-to-top" role="button" aria-label="Scroll to top">
