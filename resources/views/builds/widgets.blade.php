      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 row">
            <h1>Widgets</h1>
            <input type="color" id="colorPicker" width="30px" />
          </div>
          <div class="col-sm-6">
...
colorPicker.addEventListener("input", (e) => {
  const chosenColor = e.target.value; // hex string like "#ff0000"
  
  // Set CSS variable on root (documentElement)
  document.documentElement.style.setProperty("--icon-color", chosenColor);
});
</script>
@stop